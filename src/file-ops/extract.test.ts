        ...
        [
          {
            type: "tool_use",
            name: "Read",
            input: { file_path: "/a/foo.ts", offset: 100, limit: 50 },
          },
        ],
        "uuid-1",
        "2025-01-01T00:01:00Z",
        ...
        [
          {
            type: "tool_use",
            name: "Edit",
            input: { file_path: "/a/foo.ts", old_string: "const x = 1", new_string: "const x = 2" },
          },
        ],
        "uuid-1",
        "2025-01-01T00:01:00Z",
        ...
        [
          {
            type: "tool_use",
            name: "Read",
            input: { file_path: "/a/foo.ts", offset: 10, limit: 20 },
          },
        ],
        "u1",
        "2025-01-01T00:01:00Z",
        ...
        [
          {
            type: "tool_use",
            name: "Write",
            input: { file_path: "/a/bar.ts", content: "hello\nworld" },
          },
        ],
        "u2",
        "2025-01-01T00:02:00Z",
        ...
        [
          {
            type: "tool_use",
            name: "Write",
            input: { file_path: "/a/bar.ts", content: "single line" },
          },
        ],
        "uuid-1",
        "2025-01-01T00:01:00Z",
